# SappsUI - Layout Component System
...
```svelte
<script lang="ts">
  import { Scaffold, AppBar } from 'sappsui';
  let { children } = $props();
</script>
...
```svelte
<script lang="ts">
  import { Scaffold, AppBar, Sidebar, SideNav } from 'sappsui';
...
```svelte
<script lang="ts">
  import { Scaffold, AppBar, Sidebar, Drawer, IconButton, SideNav } from 'sappsui';
...
```svelte
<script lang="ts">
  import { Scaffold, AppBar, Sidebar, Card, SideNav, Avatar, Dropdown } from 'sappsui';
