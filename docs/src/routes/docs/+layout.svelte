<script lang="ts">
	...
	const uiItems: any = [
		{
			type: 'header',
			icon: 'fluent:star-arrow-right-start-24-regular',
		...
		{
			type: 'header',
			icon: 'fluent:layout-row-two-split-bottom-24-regular',
			label: 'Layout'
		},
		{
			label: 'Card',
		...
		{
			type: 'header',
			icon: 'fluent:hand-draw-24-regular',
			label: 'Control'
		},
		{
			label: 'Button',
