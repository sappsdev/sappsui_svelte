<script lang="ts">
	...
	import { Checkbox, Select, Section, Card, Tabs } from 'sappsui';
		...
		switch (selectedExample) {
			case 'basic':
				...
				return [
					...
					...itemsArray.map(
						(i) => `\t<div class="p-4 bg-primary-500 text-white rounded">Item ${i}</div>`
					),
					`</div>`
				].join('\n');
...
\t\t<p class="text-sm text-muted-600">Content for the first card</p>
\t</Card>
\t<Card>
\t\t<h3 class="font-semibold mb-2">Card 2</h3>
\t\t<p class="text-sm text-muted-600">Content for the second card</p>
\t</Card>
\t<Card>
\t\t<h3 class="font-semibold mb-2">Card 3</h3>
\t\t<p class="text-sm text-muted-600">Content for the third card</p>
\t</Card>
</Section>`;
...
\t</Card>
\t<Card>
\t\t<p class="text-sm text-muted-600">Footer</p>
\t</Card>
</Section>`;

			case 'card-grid':
				return `<Card class="grid-2 md:grid-4 gap-4">
\t<div class="p-4 bg-primary-100 rounded">Item 1</div>
\t<div class="p-4 bg-primary-100 rounded">Item 2</div>
\t<div class="p-4 bg-primary-100 rounded">Item 3</div>
\t<div class="p-4 bg-primary-100 rounded">Item 4</div>
\t<div class="p-4 bg-primary-100 rounded">Item 5</div>
\t<div class="p-4 bg-primary-100 rounded">Item 6</div>
\t<div class="p-4 bg-primary-100 rounded">Item 7</div>
\t<div class="p-4 bg-primary-100 rounded">Item 8</div>
</Card>`;
...
\t\t\t<p class="text-sm text-muted-600">Revenue</p>
\t\t</Card>
\t\t<Card class="flex-1">
\t\t\t<h3 class="text-2xl font-bold">89%</h3>
\t\t\t<p class="text-sm text-muted-600">Satisfaction</p>
\t\t</Card>
\t</Section>
\t
\t<Card class="grid-1 md:grid-3 gap-4">
\t\t<div class="p-4 bg-muted-100 rounded">Feature 1</div>
\t\t<div class="p-4 bg-muted-100 rounded">Feature 2</div>
\t\t<div class="p-4 bg-muted-100 rounded">Feature 3</div>
\t</Card>
</div>`;
			...
			<tbody>
				{#each gridUtilities as util}
					<tr class="border-b border-muted-100">
						...
						<td class="p-3 text-sm text-muted-600">{util.description}</td>
					</tr>
				{/each}
			</tbody>
		</table>
		...
		<div class="column gap-3">
			...
			<ul class="text-sm space-y-2 list-disc list-inside">
				<li>
					...
					<code class="px-1 py-0.5 bg-blue-100 rounded">class</code> prop
				</li>
				<li>
					<strong>Responsive:</strong> Combine with breakpoint prefixes:
					<code class="px-1 py-0.5 bg-blue-100 rounded">column lg:row</code> or
					<code class="px-1 py-0.5 bg-blue-100 rounded">grid-1 md:grid-3</code>
				</li>
				<li>
					<strong>Grid Auto-Fit:</strong> Use
					<code class="px-1 py-0.5 bg-blue-100 rounded">grid-auto-fit</code> for truly responsive layouts
					that adapt to any screen size
				</li>
				<li>
					<strong>Center:</strong> The <code class="px-1 py-0.5 bg-blue-100 rounded">center</code> utility
