<script lang="ts">
	...
	import { Section, Card, Code, Alert } from 'sappsui';
</script>

<DocHeader title="Installation">
	Get started with sappsui by following these simple steps to set up your Svelte project with
	Tailwind CSS and the sappsui component library.
</DocHeader>
...
<Section>
	...
	<div class="space-y-8">
		...
		<!-- Step 3: Install sappsui -->
		<Card>
			<div class="p-6">
				<h3 class="text-lg font-semibold mb-4">3. Install sappsui</h3>
				<p class="text-sm text-on-muted mb-4">
					Install the sappsui component library as a dependency in your project.
				</p>
				<Code code="bun add sappsui" lang="bash" showCopy />
			</div>
		</Card>
		...
		<Card>
			<div class="p-6">
				...
				<p class="text-sm text-on-muted mb-4">
					...
					includes Tailwind CSS, sappsui styles, and theme color variables.
				</p>
				<Code
  ...
  {@render children()}
		...
		<Card>
			<div class="p-6">
				...
				<p class="text-sm text-on-muted mb-4">
					Your Svelte project is now configured with sappsui. You can start using components in your
					pages.
				</p>
				<Code
					code={`<script>
  import { Button, Card } from 'sappsui';
<\/script>

<Card>
  <div class="p-6">
    <h1>Welcome to sappsui!</h1>
