<script lang="ts">
	...
	import { ComboBox, useSearch, Checkbox, Select, Section } from 'sappsui';
	...
	import { ComboBox, useSearch } from 'sappsui';
...
/>`;
		...
		return `<script lang="ts">
	import { ComboBox, useSearch, type SearchOption } from 'sappsui';
